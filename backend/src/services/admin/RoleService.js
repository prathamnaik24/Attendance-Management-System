...
export class RoleService {
  ...
  /**
   * Delete a custom role (Org Admin cannot be deleted; roles with assigned employees require reassignment).
   */
  static async deleteRole(orgId, roleId) {
    ...
    // Check if any employees are currently assigned to this role
